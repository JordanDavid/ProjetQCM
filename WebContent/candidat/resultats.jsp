...
<%
	...
	int totalBonneReponse = (Integer)request.getAttribute("totalBonneReponse");
%>
...
<script src="https://code.highcharts.com/modules/exporting.js"></script>
	...
	<div id="charts_resultats_question">
		...
		<div id="charts_bonnes_reponses" style="min-width: 100px;max-width: 250px;height: 200px;margin:auto;margin-top:5%"
			...
			data-totalBonneReponse="<%=totalBonneReponse %>" ></div>
			
		<div id="details_resultat">
			<h2>Détails du résultats</h2>
			<ul>
				<li>Nombre de bonne réponse : <%=resultat.getNbBonnesReponses()%>/<%=totalBonneReponse%>
